...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80000130:	3ec080e7          	jalr	1004(ra) # 80002518 <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    8000021a:	2ac080e7          	jalr	684(ra) # 800024c2 <either_copyout>
...
consoleintr(int c)
{
  ...
  case C('P'):  // Print process list.
    ...
    800002fc:	276080e7          	jalr	630(ra) # 8000256e <procdump>
      }
    }
    break;
  }
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000482:	f3a78793          	addi	a5,a5,-198 # 800213b8 <devsw>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a16:	b3e78793          	addi	a5,a5,-1218 # 80022550 <end>
...
0000000080000abe <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ae6:	a6e50513          	addi	a0,a0,-1426 # 80022550 <end>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ede:	7d4080e7          	jalr	2004(ra) # 800026ae <trapinithart>
  ...
  scheduler();        
    ...
    80000f56:	734080e7          	jalr	1844(ra) # 80002686 <trapinit>
    trapinithart();  // install kernel trap vector
    80000f5a:	00001097          	auipc	ra,0x1
    80000f5e:	754080e7          	jalr	1876(ra) # 800026ae <trapinithart>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001884:	8f0a0a13          	addi	s4,s4,-1808 # 80017170 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001950:	82498993          	addi	s3,s3,-2012 # 80017170 <tickslock>
      initlock(&p->lock, "proc");
    ...
    8000195c:	202080e7          	jalr	514(ra) # 80000b5a <initlock>
      p->state = UNUSED;
    80001960:	0204ac23          	sw	zero,56(s1)
      p->kstack = KSTACK((int) (p - proc));
...
forkret(void)
{
  ...
  if (first) {
    ...
    80001a1a:	e3a7a783          	lw	a5,-454(a5) # 80008850 <first.1686>
  ...
  usertrapret();
    ...
    80001a24:	ca6080e7          	jalr	-858(ra) # 800026c6 <usertrapret>
}
    ...
    80001a34:	e207a023          	sw	zero,-480(a5) # 80008850 <first.1686>
    fsinit(ROOTDEV);
...
0000000080001a8a <proc_pagetable>:
{
  ...
  if(mappages(pagetable, TRAPFRAME, PGSIZE,
    ...
    80001ac6:	07893683          	ld	a3,120(s2)
...
0000000080001bd0 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001be8:	58c90913          	addi	s2,s2,1420 # 80017170 <tickslock>
    acquire(&p->lock);
    80001bec:	8526                	mv	a0,s1
    80001bee:	fffff097          	auipc	ra,0xfffff
    80001bf2:	ffc080e7          	jalr	-4(ra) # 80000bea <acquire>
    if(p->state == UNUSED) {
    80001bf6:	5c9c                	lw	a5,56(s1)
  ...
  p->context.ra = (uint64)forkret;
    ...
    80001c56:	e0dc                	sd	a5,128(s1)
  p->context.sp = p->kstack + PGSIZE;
    80001c58:	70bc                	ld	a5,96(s1)
    80001c5a:	6705                	lui	a4,0x1
    80001c5c:	97ba                	add	a5,a5,a4
    80001c5e:	e4dc                	sd	a5,136(s1)
}
...
0000000080001c9e <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001d04:	16a4b823          	sd	a0,368(s1)
  p->state = RUNNABLE;
...
0000000080001d7c <fork>:
{
  ...
  if(uvmcopy(p->pagetable, np->pagetable, p->sz) < 0){
    80001da4:	06893603          	ld	a2,104(s2)
    80001da8:	792c                	ld	a1,112(a0)
    80001daa:	07093503          	ld	a0,112(s2)
    80001dae:	fffff097          	auipc	ra,0xfffff
    80001db2:	7d2080e7          	jalr	2002(ra) # 80001580 <uvmcopy>
    80001db6:	04054663          	bltz	a0,80001e02 <fork+0x86>
  np->sz = p->sz;
    80001dba:	06893783          	ld	a5,104(s2)
    80001dbe:	06f9b423          	sd	a5,104(s3)
  *(np->trapframe) = *(p->trapframe);
    80001dc2:	07893683          	ld	a3,120(s2)
    80001dc6:	87b6                	mv	a5,a3
    80001dc8:	0789b703          	ld	a4,120(s3)
  ...
  np->trapframe->a0 = 0;
    80001df0:	0789b783          	ld	a5,120(s3)
    80001df4:	0607b823          	sd	zero,112(a5)
    80001df8:	0f000493          	li	s1,240
  for(i = 0; i < NOFILE; i++)
    80001dfc:	17000a13          	li	s4,368
...
0000000080001eb8 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001f00:	27490913          	addi	s2,s2,628 # 80017170 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001f18:	a03d                	j	80001f46 <scheduler+0x8e>
        p->state = RUNNING;
    80001f1a:	0364ac23          	sw	s6,56(s1)
        c->proc = p;
    80001f1e:	029a3823          	sd	s1,48(s4)
        swtch(&c->context, &p->context);
    80001f22:	08048593          	addi	a1,s1,128
    80001f26:	8556                	mv	a0,s5
    80001f28:	00000097          	auipc	ra,0x0
    80001f2c:	6f4080e7          	jalr	1780(ra) # 8000261c <swtch>
        c->proc = 0;
...
0000000080001f58 <sched>:
{
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001fc8:	08048513          	addi	a0,s1,128
    80001fcc:	00000097          	auipc	ra,0x0
    80001fd0:	650080e7          	jalr	1616(ra) # 8000261c <swtch>
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  // Go to sleep.
  p->chan = chan;
    80002098:	0534b023          	sd	s3,64(s1)
  p->state = SLEEPING;
    8000209c:	4789                	li	a5,2
    8000209e:	dc9c                	sw	a5,56(s1)
  ...
  // Tidy up.
  p->chan = 0;
    800020a8:	0404b023          	sd	zero,64(s1)
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020f2:	08290913          	addi	s2,s2,130 # 80017170 <tickslock>
    800020f6:	a821                	j	8000210e <wakeup+0x40>
        p->state = RUNNABLE;
    800020f8:	0354ac23          	sw	s5,56(s1)
      }
      release(&p->lock);
...
0000000080002144 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000216a:	00a98993          	addi	s3,s3,10 # 80017170 <tickslock>
...
000000008000219e <exit>:
{
  ...
  if(p == initproc)
    ...
    800021c2:	0f050493          	addi	s1,a0,240
    800021c6:	17050913          	addi	s2,a0,368
  ...
  iput(p->cwd);
    800021fe:	1709b503          	ld	a0,368(s3)
  ...
  p->cwd = 0;
    80002212:	1609b823          	sd	zero,368(s3)
  acquire(&wait_lock);
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002290:	ee498993          	addi	s3,s3,-284 # 80017170 <tickslock>
    acquire(&p->lock);
    80002294:	8526                	mv	a0,s1
    80002296:	fffff097          	auipc	ra,0xfffff
    8000229a:	954080e7          	jalr	-1708(ra) # 80000bea <acquire>
    if(p->pid == pid){
    8000229e:	48bc                	lw	a5,80(s1)
...
int wait(uint64 addr, uint64 msg_addr){
  ...
  struct proc *p = myproc();
    ...
    80002366:	664080e7          	jalr	1636(ra) # 800019c6 <myproc>
    8000236a:	892a                	mv	s2,a0
  acquire(&wait_lock);
    8000236c:	0000e517          	auipc	a0,0xe
    80002370:	7ec50513          	addi	a0,a0,2028 # 80010b58 <wait_lock>
    ...
    80002384:	df098993          	addi	s3,s3,-528 # 80017170 <tickslock>
        havekids = 1;
    80002388:	4a85                	li	s5,1
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000238a:	0000ec97          	auipc	s9,0xe
    8000238e:	7cec8c93          	addi	s9,s9,1998 # 80010b58 <wait_lock>
    havekids = 0;
    80002392:	8762                	mv	a4,s8
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002394:	0000f497          	auipc	s1,0xf
    80002398:	bdc48493          	addi	s1,s1,-1060 # 80010f70 <proc>
    8000239c:	a865                	j	80002454 <wait+0x110>
          pid = pp->pid;
    8000239e:	0504a983          	lw	s3,80(s1)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    800023a2:	040b9b63          	bnez	s7,800023f8 <wait+0xb4>
          if(msg_addr != 0 && copyout(p->pagetable, msg_addr, pp->exit_msg, strlen(pp->exit_msg) + 1) < 0) {
    800023a6:	020b0663          	beqz	s6,800023d2 <wait+0x8e>
    800023aa:	07093a03          	ld	s4,112(s2)
    800023ae:	01848913          	addi	s2,s1,24
    800023b2:	854a                	mv	a0,s2
    800023b4:	fffff097          	auipc	ra,0xfffff
    800023b8:	ab6080e7          	jalr	-1354(ra) # 80000e6a <strlen>
    800023bc:	0015069b          	addiw	a3,a0,1
    800023c0:	864a                	mv	a2,s2
    800023c2:	85da                	mv	a1,s6
    800023c4:	8552                	mv	a0,s4
    800023c6:	fffff097          	auipc	ra,0xfffff
    800023ca:	2be080e7          	jalr	702(ra) # 80001684 <copyout>
    800023ce:	06054063          	bltz	a0,8000242e <wait+0xea>
          freeproc(pp);
    800023d2:	8526                	mv	a0,s1
    800023d4:	fffff097          	auipc	ra,0xfffff
    800023d8:	7a4080e7          	jalr	1956(ra) # 80001b78 <freeproc>
          release(&pp->lock);
    ...
    800023ea:	77250513          	addi	a0,a0,1906 # 80010b58 <wait_lock>
    800023ee:	fffff097          	auipc	ra,0xfffff
    800023f2:	8b0080e7          	jalr	-1872(ra) # 80000c9e <release>
          return pid;
    800023f6:	a04d                	j	80002498 <wait+0x154>
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    800023f8:	4691                	li	a3,4
    800023fa:	04c48613          	addi	a2,s1,76
    800023fe:	85de                	mv	a1,s7
    80002400:	07093503          	ld	a0,112(s2)
    80002404:	fffff097          	auipc	ra,0xfffff
    80002408:	280080e7          	jalr	640(ra) # 80001684 <copyout>
    8000240c:	f8055de3          	bgez	a0,800023a6 <wait+0x62>
            release(&pp->lock);
    ...
    8000241e:	73e50513          	addi	a0,a0,1854 # 80010b58 <wait_lock>
    80002422:	fffff097          	auipc	ra,0xfffff
    80002426:	87c080e7          	jalr	-1924(ra) # 80000c9e <release>
            return -1;
    8000242a:	59fd                	li	s3,-1
    8000242c:	a0b5                	j	80002498 <wait+0x154>
           release(&pp->lock);
    ...
    8000244a:	a0b9                	j	80002498 <wait+0x154>
    for(pp = proc; pp < &proc[NPROC]; pp++){
    8000244c:	18848493          	addi	s1,s1,392
    80002450:	03348463          	beq	s1,s3,80002478 <wait+0x134>
      if(pp->parent == p){
    80002454:	6cbc                	ld	a5,88(s1)
    80002456:	ff279be3          	bne	a5,s2,8000244c <wait+0x108>
        acquire(&pp->lock);
    8000245a:	8526                	mv	a0,s1
    8000245c:	ffffe097          	auipc	ra,0xffffe
    80002460:	78e080e7          	jalr	1934(ra) # 80000bea <acquire>
        if(pp->state == ZOMBIE){
    80002464:	5c9c                	lw	a5,56(s1)
    80002466:	f3478ce3          	beq	a5,s4,8000239e <wait+0x5a>
        release(&pp->lock);
    ...
    80002476:	bfd9                	j	8000244c <wait+0x108>
    if(!havekids || killed(p)){
    80002478:	c719                	beqz	a4,80002486 <wait+0x142>
    8000247a:	854a                	mv	a0,s2
    8000247c:	00000097          	auipc	ra,0x0
    80002480:	e96080e7          	jalr	-362(ra) # 80002312 <killed>
    80002484:	c905                	beqz	a0,800024b4 <wait+0x170>
      release(&wait_lock);
    80002486:	0000e517          	auipc	a0,0xe
    8000248a:	6d250513          	addi	a0,a0,1746 # 80010b58 <wait_lock>
    ...
    8000249a:	60e6                	ld	ra,88(sp)
    8000249c:	6446                	ld	s0,80(sp)
    8000249e:	64a6                	ld	s1,72(sp)
    800024a0:	6906                	ld	s2,64(sp)
    800024a2:	79e2                	ld	s3,56(sp)
    800024a4:	7a42                	ld	s4,48(sp)
    800024a6:	7aa2                	ld	s5,40(sp)
    800024a8:	7b02                	ld	s6,32(sp)
    800024aa:	6be2                	ld	s7,24(sp)
    800024ac:	6c42                	ld	s8,16(sp)
    800024ae:	6ca2                	ld	s9,8(sp)
    800024b0:	6125                	addi	sp,sp,96
    800024b2:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800024b4:	85e6                	mv	a1,s9
    800024b6:	854a                	mv	a0,s2
    800024b8:	00000097          	auipc	ra,0x0
    800024bc:	bb2080e7          	jalr	-1102(ra) # 8000206a <sleep>
    havekids = 0;
    800024c0:	bdc9                	j	80002392 <wait+0x4e>
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    800024de:	4ec080e7          	jalr	1260(ra) # 800019c6 <myproc>
  if(user_dst){
    ...
    800024ea:	7928                	ld	a0,112(a0)
    800024ec:	fffff097          	auipc	ra,0xfffff
    800024f0:	198080e7          	jalr	408(ra) # 80001684 <copyout>
  } else {
    ...
    80002510:	83a080e7          	jalr	-1990(ra) # 80000d46 <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002534:	496080e7          	jalr	1174(ra) # 800019c6 <myproc>
  if(user_src){
    ...
    80002540:	7928                	ld	a0,112(a0)
    80002542:	fffff097          	auipc	ra,0xfffff
    80002546:	1ce080e7          	jalr	462(ra) # 80001710 <copyin>
  } else {
    ...
    80002566:	7e4080e7          	jalr	2020(ra) # 80000d46 <memmove>
    return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80002588:	b4450513          	addi	a0,a0,-1212 # 800080c8 <digits+0x88>
    8000258c:	ffffe097          	auipc	ra,0xffffe
    80002590:	002080e7          	jalr	2(ra) # 8000058e <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    80002594:	0000f497          	auipc	s1,0xf
    80002598:	b5448493          	addi	s1,s1,-1196 # 800110e8 <proc+0x178>
    8000259c:	00015917          	auipc	s2,0x15
    800025a0:	d4c90913          	addi	s2,s2,-692 # 800172e8 <bcache+0x160>
    if(p->state == UNUSED)
      continue;
    ...
    800025aa:	cda98993          	addi	s3,s3,-806 # 80008280 <digits+0x240>
    printf("%d %s %s", p->pid, state, p->name);
    800025ae:	00006a97          	auipc	s5,0x6
    800025b2:	cdaa8a93          	addi	s5,s5,-806 # 80008288 <digits+0x248>
    printf("\n");
    800025b6:	00006a17          	auipc	s4,0x6
    800025ba:	b12a0a13          	addi	s4,s4,-1262 # 800080c8 <digits+0x88>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    800025be:	00006b97          	auipc	s7,0x6
    800025c2:	d0ab8b93          	addi	s7,s7,-758 # 800082c8 <states.1730>
    800025c6:	a00d                	j	800025e8 <procdump+0x7a>
    printf("%d %s %s", p->pid, state, p->name);
    800025c8:	ed86a583          	lw	a1,-296(a3)
    800025cc:	8556                	mv	a0,s5
    800025ce:	ffffe097          	auipc	ra,0xffffe
    800025d2:	fc0080e7          	jalr	-64(ra) # 8000058e <printf>
    printf("\n");
    800025d6:	8552                	mv	a0,s4
    800025d8:	ffffe097          	auipc	ra,0xffffe
    800025dc:	fb6080e7          	jalr	-74(ra) # 8000058e <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    800025e0:	18848493          	addi	s1,s1,392
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002692:	c6a58593          	addi	a1,a1,-918 # 800082f8 <states.1730+0x30>
    80002696:	00015517          	auipc	a0,0x15
    8000269a:	ada50513          	addi	a0,a0,-1318 # 80017170 <tickslock>
    8000269e:	ffffe097          	auipc	ra,0xffffe
    800026a2:	4bc080e7          	jalr	1212(ra) # 80000b5a <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800026b8:	55c78793          	addi	a5,a5,1372 # 80005c10 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    800026d2:	2f8080e7          	jalr	760(ra) # 800019c6 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    8000276a:	a0a48493          	addi	s1,s1,-1526 # 80017170 <tickslock>
    8000276e:	8526                	mv	a0,s1
    80002770:	ffffe097          	auipc	ra,0xffffe
    80002774:	47a080e7          	jalr	1146(ra) # 80000bea <acquire>
  ticks++;
    80002778:	00006517          	auipc	a0,0x6
    8000277c:	15850513          	addi	a0,a0,344 # 800088d0 <ticks>
    80002780:	411c                	lw	a5,0(a0)
    80002782:	2785                	addiw	a5,a5,1
    80002784:	c11c                	sw	a5,0(a0)
  wakeup(&ticks);
    80002786:	00000097          	auipc	ra,0x0
    8000278a:	948080e7          	jalr	-1720(ra) # 800020ce <wakeup>
  release(&tickslock);
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    800027d8:	544080e7          	jalr	1348(ra) # 80005d18 <plic_claim>
...
0000000080002844 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000285e:	3b678793          	addi	a5,a5,950 # 80005c10 <kernelvec>
  ...
  usertrapret();
    ...
    8000290a:	898080e7          	jalr	-1896(ra) # 8000219e <exit>
    8000290e:	b765                	j	800028b6 <usertrap+0x72>
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002910:	142025f3          	csrr	a1,scause
    printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    80002914:	48b0                	lw	a2,80(s1)
    80002916:	00006517          	auipc	a0,0x6
    8000291a:	a2a50513          	addi	a0,a0,-1494 # 80008340 <states.1730+0x78>
    8000291e:	ffffe097          	auipc	ra,0xffffe
    80002922:	c70080e7          	jalr	-912(ra) # 8000058e <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002932:	a4250513          	addi	a0,a0,-1470 # 80008370 <states.1730+0xa8>
    ...
    80002944:	9a6080e7          	jalr	-1626(ra) # 800022e6 <setkilled>
    80002948:	b769                	j	800028d2 <usertrap+0x8e>
    yield();
    8000294a:	fffff097          	auipc	ra,0xfffff
    8000294e:	6e4080e7          	jalr	1764(ra) # 8000202e <yield>
...
0000000080002954 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800029a6:	9ee50513          	addi	a0,a0,-1554 # 80008390 <states.1730+0xc8>
    800029aa:	ffffe097          	auipc	ra,0xffffe
    800029ae:	b9a080e7          	jalr	-1126(ra) # 80000544 <panic>
    panic("kerneltrap: interrupts enabled");
    800029b2:	00006517          	auipc	a0,0x6
    800029b6:	a0650513          	addi	a0,a0,-1530 # 800083b8 <states.1730+0xf0>
    800029ba:	ffffe097          	auipc	ra,0xffffe
    800029be:	b8a080e7          	jalr	-1142(ra) # 80000544 <panic>
    printf("scause %p\n", scause);
    800029c2:	85ce                	mv	a1,s3
    800029c4:	00006517          	auipc	a0,0x6
    800029c8:	a1450513          	addi	a0,a0,-1516 # 800083d8 <states.1730+0x110>
    800029cc:	ffffe097          	auipc	ra,0xffffe
    800029d0:	bc2080e7          	jalr	-1086(ra) # 8000058e <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800029e0:	a0c50513          	addi	a0,a0,-1524 # 800083e8 <states.1730+0x120>
    800029e4:	ffffe097          	auipc	ra,0xffffe
    800029e8:	baa080e7          	jalr	-1110(ra) # 8000058e <printf>
    panic("kerneltrap");
    800029ec:	00006517          	auipc	a0,0x6
    800029f0:	a1450513          	addi	a0,a0,-1516 # 80008400 <states.1730+0x138>
  ...
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    80002a0a:	fc0080e7          	jalr	-64(ra) # 800019c6 <myproc>
    80002a0e:	5d18                	lw	a4,56(a0)
    80002a10:	4791                	li	a5,4
    80002a12:	f6f71de3          	bne	a4,a5,8000298c <kerneltrap+0x38>
    yield();
    80002a16:	fffff097          	auipc	ra,0xfffff
    80002a1a:	618080e7          	jalr	1560(ra) # 8000202e <yield>
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    ...
    80002a30:	f9a080e7          	jalr	-102(ra) # 800019c6 <myproc>
  switch (n) {
    ...
    80002a40:	9fc70713          	addi	a4,a4,-1540 # 80008438 <states.1730+0x170>
...
0000000080002a88 <fetchaddr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002a9c:	f2e080e7          	jalr	-210(ra) # 800019c6 <myproc>
  if(addr >= p->sz || addr+sizeof(uint64) > p->sz) // both tests needed, in case of overflow
    80002aa0:	753c                	ld	a5,104(a0)
  ...
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    ...
    80002ab4:	7928                	ld	a0,112(a0)
    80002ab6:	fffff097          	auipc	ra,0xfffff
    80002aba:	c5a080e7          	jalr	-934(ra) # 80001710 <copyin>
...
syscall(void)
{
  ...
  num = p->trapframe->a7;
    80002bb4:	07853903          	ld	s2,120(a0)
    80002bb8:	0a893783          	ld	a5,168(s2)
    80002bbc:	0007869b          	sext.w	a3,a5
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002bc0:	37fd                	addiw	a5,a5,-1
    80002bc2:	4759                	li	a4,22
    80002bc4:	00f76f63          	bltu	a4,a5,80002be2 <syscall+0x44>
    80002bc8:	00369713          	slli	a4,a3,0x3
    80002bcc:	00006797          	auipc	a5,0x6
    80002bd0:	88478793          	addi	a5,a5,-1916 # 80008450 <syscalls>
    80002bd4:	97ba                	add	a5,a5,a4
    80002bd6:	639c                	ld	a5,0(a5)
    80002bd8:	c789                	beqz	a5,80002be2 <syscall+0x44>
    // Use num to lookup the system call function for num, call it,
    // and store its return value in p->trapframe->a0
    p->trapframe->a0 = syscalls[num]();
    80002bda:	9782                	jalr	a5
    80002bdc:	06a93823          	sd	a0,112(s2)
    80002be0:	a839                	j	80002bfe <syscall+0x60>
  } else {
    printf("%d %s: unknown sys call %d\n",
    80002be2:	17848613          	addi	a2,s1,376
    80002be6:	48ac                	lw	a1,80(s1)
    80002be8:	00006517          	auipc	a0,0x6
    80002bec:	83050513          	addi	a0,a0,-2000 # 80008418 <states.1730+0x150>
    80002bf0:	ffffe097          	auipc	ra,0xffffe
    80002bf4:	99e080e7          	jalr	-1634(ra) # 8000058e <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
    80002bf8:	7cbc                	ld	a5,120(s1)
...
sys_memsize(void)
{
  ...
  struct proc *p = myproc(); // קבל את התהליך הנוכחי
    ...
    80002c16:	db4080e7          	jalr	-588(ra) # 800019c6 <myproc>
  return p->sz; 
}
    80002c1a:	7528                	ld	a0,104(a0)
...
sys_exit(void)
{
    80002c24:	715d                	addi	sp,sp,-80
    80002c26:	e486                	sd	ra,72(sp)
    80002c28:	e0a2                	sd	s0,64(sp)
    80002c2a:	fc26                	sd	s1,56(sp)
    80002c2c:	0880                	addi	s0,sp,80
  int status;
  char msg[32] = {0};
    80002c2e:	fa043c23          	sd	zero,-72(s0)
    80002c32:	fc043023          	sd	zero,-64(s0)
    80002c36:	fc043423          	sd	zero,-56(s0)
    80002c3a:	fc043823          	sd	zero,-48(s0)

  argint(0, &status); 
    80002c3e:	fdc40593          	addi	a1,s0,-36
    80002c42:	4501                	li	a0,0
    80002c44:	00000097          	auipc	ra,0x0
    80002c48:	ee2080e7          	jalr	-286(ra) # 80002b26 <argint>
  argstr(1, msg, sizeof(msg)); // ארגומנט 2: הודעת יציאה
    80002c4c:	02000613          	li	a2,32
    80002c50:	fb840593          	addi	a1,s0,-72
    80002c54:	4505                	li	a0,1
    80002c56:	00000097          	auipc	ra,0x0
    80002c5a:	f10080e7          	jalr	-240(ra) # 80002b66 <argstr>

  struct proc *p = myproc();
    80002c5e:	fffff097          	auipc	ra,0xfffff
    80002c62:	d68080e7          	jalr	-664(ra) # 800019c6 <myproc>
    80002c66:	84aa                	mv	s1,a0
  strncpy(p->exit_msg, msg, sizeof(p->exit_msg)); // שמור בהודעת יציאה
    80002c68:	02000613          	li	a2,32
    80002c6c:	fb840593          	addi	a1,s0,-72
    80002c70:	0561                	addi	a0,a0,24
    80002c72:	ffffe097          	auipc	ra,0xffffe
    80002c76:	188080e7          	jalr	392(ra) # 80000dfa <strncpy>
  p->exit_msg[31] = '\0'; // ודא סיום תקין
    80002c7a:	02048ba3          	sb	zero,55(s1)

  exit(status); 
    80002c7e:	fdc42503          	lw	a0,-36(s0)
    80002c82:	fffff097          	auipc	ra,0xfffff
    80002c86:	51c080e7          	jalr	1308(ra) # 8000219e <exit>
  return 0;     
}
...
sys_exit2(void)
{
  ...
  argint(0, &status);
    ...
    80002ca8:	e82080e7          	jalr	-382(ra) # 80002b26 <argint>
  argstr(1, myproc()->exit_msg, 32);  // copy exit message directly
    80002cac:	fffff097          	auipc	ra,0xfffff
    80002cb0:	d1a080e7          	jalr	-742(ra) # 800019c6 <myproc>
    80002cb4:	02000613          	li	a2,32
    80002cb8:	01850593          	addi	a1,a0,24
    80002cbc:	4505                	li	a0,1
    80002cbe:	00000097          	auipc	ra,0x0
    80002cc2:	ea8080e7          	jalr	-344(ra) # 80002b66 <argstr>
  exit(status);
    80002cc6:	fec42503          	lw	a0,-20(s0)
    80002cca:	fffff097          	auipc	ra,0xfffff
    80002cce:	4d4080e7          	jalr	1236(ra) # 8000219e <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002ce8:	ce2080e7          	jalr	-798(ra) # 800019c6 <myproc>
}
    80002cec:	4928                	lw	a0,80(a0)
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002d02:	07e080e7          	jalr	126(ra) # 80001d7c <fork>
}
...
sys_sbrk(void)
{
  ...
  argint(0, &n);
    ...
    80002d5e:	dcc080e7          	jalr	-564(ra) # 80002b26 <argint>
  addr = myproc()->sz;
    80002d62:	fffff097          	auipc	ra,0xfffff
    80002d66:	c64080e7          	jalr	-924(ra) # 800019c6 <myproc>
    80002d6a:	7524                	ld	s1,104(a0)
  if(growproc(n) < 0)
    80002d6c:	fdc42503          	lw	a0,-36(s0)
    80002d70:	fffff097          	auipc	ra,0xfffff
    80002d74:	fb0080e7          	jalr	-80(ra) # 80001d20 <growproc>
    80002d78:	00054863          	bltz	a0,80002d88 <sys_sbrk+0x3e>
    return -1;
  return addr;
}
    ...
    80002d8a:	bfcd                	j	80002d7c <sys_sbrk+0x32>
...
sys_sleep(void)
{
  ...
  argint(0, &n);
    ...
    80002da4:	d86080e7          	jalr	-634(ra) # 80002b26 <argint>
  acquire(&tickslock);
    80002da8:	00014517          	auipc	a0,0x14
    80002dac:	3c850513          	addi	a0,a0,968 # 80017170 <tickslock>
    80002db0:	ffffe097          	auipc	ra,0xffffe
    80002db4:	e3a080e7          	jalr	-454(ra) # 80000bea <acquire>
  ticks0 = ticks;
    80002db8:	00006917          	auipc	s2,0x6
    80002dbc:	b1892903          	lw	s2,-1256(s2) # 800088d0 <ticks>
  while(ticks - ticks0 < n){
    ...
    80002dca:	3aa98993          	addi	s3,s3,938 # 80017170 <tickslock>
    80002dce:	00006497          	auipc	s1,0x6
    80002dd2:	b0248493          	addi	s1,s1,-1278 # 800088d0 <ticks>
    if(killed(myproc())){
    80002dd6:	fffff097          	auipc	ra,0xfffff
    80002dda:	bf0080e7          	jalr	-1040(ra) # 800019c6 <myproc>
    80002dde:	fffff097          	auipc	ra,0xfffff
    80002de2:	534080e7          	jalr	1332(ra) # 80002312 <killed>
    ...
    80002df0:	27e080e7          	jalr	638(ra) # 8000206a <sleep>
  while(ticks - ticks0 < n){
  ...
  release(&tickslock);
    ...
    80002e06:	36e50513          	addi	a0,a0,878 # 80017170 <tickslock>
  ...
  return 0;
    ...
    80002e26:	34e50513          	addi	a0,a0,846 # 80017170 <tickslock>
...
sys_kill(void)
{
  ...
  argint(0, &pid);
    ...
    80002e48:	ce2080e7          	jalr	-798(ra) # 80002b26 <argint>
  return kill(pid);
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002e6e:	30650513          	addi	a0,a0,774 # 80017170 <tickslock>
    80002e72:	ffffe097          	auipc	ra,0xffffe
    80002e76:	d78080e7          	jalr	-648(ra) # 80000bea <acquire>
  xticks = ticks;
    80002e7a:	00006497          	auipc	s1,0x6
    80002e7e:	a564a483          	lw	s1,-1450(s1) # 800088d0 <ticks>
  release(&tickslock);
    80002e82:	00014517          	auipc	a0,0x14
    80002e86:	2ee50513          	addi	a0,a0,750 # 80017170 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002eb6:	65e58593          	addi	a1,a1,1630 # 80008510 <syscalls+0xc0>
    80002eba:	00014517          	auipc	a0,0x14
    80002ebe:	2ce50513          	addi	a0,a0,718 # 80017188 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002ece:	2be78793          	addi	a5,a5,702 # 8001f188 <bcache+0x8000>
    80002ed2:	0001c717          	auipc	a4,0x1c
    80002ed6:	51e70713          	addi	a4,a4,1310 # 8001f3f0 <bcache+0x8268>
    80002eda:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002ede:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002ee2:	00014497          	auipc	s1,0x14
    80002ee6:	2be48493          	addi	s1,s1,702 # 800171a0 <bcache+0x18>
    ...
    80002ef2:	62aa0a13          	addi	s4,s4,1578 # 80008518 <syscalls+0xc8>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f46:	24650513          	addi	a0,a0,582 # 80017188 <bcache>
    80002f4a:	ffffe097          	auipc	ra,0xffffe
    80002f4e:	ca0080e7          	jalr	-864(ra) # 80000bea <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002f52:	0001c497          	auipc	s1,0x1c
    80002f56:	4ee4b483          	ld	s1,1262(s1) # 8001f440 <bcache+0x82b8>
    80002f5a:	0001c797          	auipc	a5,0x1c
    80002f5e:	49678793          	addi	a5,a5,1174 # 8001f3f0 <bcache+0x8268>
    ...
    80002f86:	20650513          	addi	a0,a0,518 # 80017188 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002fa4:	4984b483          	ld	s1,1176(s1) # 8001f438 <bcache+0x82b0>
    80002fa8:	0001c797          	auipc	a5,0x1c
    80002fac:	44878793          	addi	a5,a5,1096 # 8001f3f0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002fc4:	56050513          	addi	a0,a0,1376 # 80008520 <syscalls+0xd0>
    ...
    80002fe4:	1a850513          	addi	a0,a0,424 # 80017188 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80003054:	4e850513          	addi	a0,a0,1256 # 80008538 <syscalls+0xe8>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    8000308c:	10050513          	addi	a0,a0,256 # 80017188 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    800030b4:	0d878793          	addi	a5,a5,216 # 8001f188 <bcache+0x8000>
    800030b8:	2b87b703          	ld	a4,696(a5)
    800030bc:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800030be:	0001c717          	auipc	a4,0x1c
    800030c2:	33270713          	addi	a4,a4,818 # 8001f3f0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    800030d6:	0b650513          	addi	a0,a0,182 # 80017188 <bcache>
    ...
    800030f2:	45250513          	addi	a0,a0,1106 # 80008540 <syscalls+0xf0>
...
bpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80003124:	06850513          	addi	a0,a0,104 # 80017188 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000314a:	04250513          	addi	a0,a0,66 # 80017188 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003160:	02c50513          	addi	a0,a0,44 # 80017188 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    8000318c:	6dc7a783          	lw	a5,1756(a5) # 8001f864 <sb+0x1c>
  ...
  brelse(bp);
    ...
    800031e6:	36650513          	addi	a0,a0,870 # 80008548 <syscalls+0xf8>
...
00000000800031f2 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003210:	6407a783          	lw	a5,1600(a5) # 8001f84c <sb+0x4>
    ...
    80003220:	62cb0b13          	addi	s6,s6,1580 # 8001f848 <sb>
  ...
  printf("balloc: out of blocks\n");
    ...
    8000331a:	24a50513          	addi	a0,a0,586 # 80008560 <syscalls+0x110>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003406:	17650513          	addi	a0,a0,374 # 80008578 <syscalls+0x128>
...
0000000080003412 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000342a:	44250513          	addi	a0,a0,1090 # 8001f868 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000343c:	44848493          	addi	s1,s1,1096 # 8001f880 <itable+0x18>
    80003440:	0001e697          	auipc	a3,0x1e
    80003444:	ed068693          	addi	a3,a3,-304 # 80021310 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003470:	3fc50513          	addi	a0,a0,1020 # 8001f868 <itable>
  ...
  release(&itable.lock);
    ...
    800034a0:	3cc50513          	addi	a0,a0,972 # 8001f868 <itable>
    ...
    800034c2:	0d250513          	addi	a0,a0,210 # 80008590 <syscalls+0x140>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800034ee:	35e98993          	addi	s3,s3,862 # 8001f848 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003522:	32a58593          	addi	a1,a1,810 # 8001f848 <sb>
    ...
    80003542:	06250513          	addi	a0,a0,98 # 800085a0 <syscalls+0x150>
...
000000008000354e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003560:	05c58593          	addi	a1,a1,92 # 800085b8 <syscalls+0x168>
    80003564:	0001c517          	auipc	a0,0x1c
    80003568:	30450513          	addi	a0,a0,772 # 8001f868 <itable>
    8000356c:	ffffd097          	auipc	ra,0xffffd
    80003570:	5ee080e7          	jalr	1518(ra) # 80000b5a <initlock>
  for(i = 0; i < NINODE; i++) {
    80003574:	0001c497          	auipc	s1,0x1c
    80003578:	31c48493          	addi	s1,s1,796 # 8001f890 <itable+0x28>
    8000357c:	0001e997          	auipc	s3,0x1e
    80003580:	da498993          	addi	s3,s3,-604 # 80021320 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003584:	00005917          	auipc	s2,0x5
    80003588:	03c90913          	addi	s2,s2,60 # 800085c0 <syscalls+0x170>
...
00000000800035ae <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800035c8:	29072703          	lw	a4,656(a4) # 8001f854 <sb+0xc>
    ...
    800035dc:	270a0a13          	addi	s4,s4,624 # 8001f848 <sb>
  ...
  printf("ialloc: no inodes\n");
    ...
    80003626:	fa650513          	addi	a0,a0,-90 # 800085c8 <syscalls+0x178>
...
0000000080003680 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003698:	1cc5a583          	lw	a1,460(a1) # 8001f860 <sb+0x18>
...
000000008000370c <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    8000371c:	15050513          	addi	a0,a0,336 # 8001f868 <itable>
  ...
  release(&itable.lock);
    ...
    80003732:	13a50513          	addi	a0,a0,314 # 8001f868 <itable>
...
000000008000374a <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003794:	0d05a583          	lw	a1,208(a1) # 8001f860 <sb+0x18>
    ...
    80003800:	dec50513          	addi	a0,a0,-532 # 800085e8 <syscalls+0x198>
...
000000008000380c <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    8000384c:	db050513          	addi	a0,a0,-592 # 800085f8 <syscalls+0x1a8>
...
0000000080003904 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003916:	f5650513          	addi	a0,a0,-170 # 8001f868 <itable>
  ...
  release(&itable.lock);
    ...
    80003934:	f3850513          	addi	a0,a0,-200 # 8001f868 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003968:	f0450513          	addi	a0,a0,-252 # 8001f868 <itable>
    ...
    8000399e:	ece50513          	addi	a0,a0,-306 # 8001f868 <itable>
    ...
    80003a00:	0ed7e963          	bltu	a5,a3,80003af2 <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003a62:	a64080e7          	jalr	-1436(ra) # 800024c2 <either_copyout>
    ...
    80003af8:	10d7e863          	bltu	a5,a3,80003c08 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003b5a:	9c2080e7          	jalr	-1598(ra) # 80002518 <either_copyin>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003c5c:	9a850513          	addi	a0,a0,-1624 # 80008600 <syscalls+0x1b0>
    80003c60:	ffffd097          	auipc	ra,0xffffd
    80003c64:	8e4080e7          	jalr	-1820(ra) # 80000544 <panic>
      panic("dirlookup read");
    80003c68:	00005517          	auipc	a0,0x5
    80003c6c:	9b050513          	addi	a0,a0,-1616 # 80008618 <syscalls+0x1c8>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003d12:	17053503          	ld	a0,368(a0)
...
0000000080003e3e <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003ee4:	74850513          	addi	a0,a0,1864 # 80008628 <syscalls+0x1d8>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003f3a:	3da90913          	addi	s2,s2,986 # 80021310 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003f5e:	3e678793          	addi	a5,a5,998 # 80021340 <log+0x30>
    ...
    80003f72:	3d660613          	addi	a2,a2,982 # 80021344 <log+0x34>
...
0000000080003fa4 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003fa8:	3987a783          	lw	a5,920(a5) # 8002133c <log+0x2c>
    80003fac:	0af05d63          	blez	a5,80004066 <install_trans+0xc2>
{
    ...
    80003fca:	37aa8a93          	addi	s5,s5,890 # 80021340 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003fce:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003fd0:	0001d997          	auipc	s3,0x1d
    80003fd4:	34098993          	addi	s3,s3,832 # 80021310 <log>
...
0000000080004068 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000407e:	29648493          	addi	s1,s1,662 # 80021310 <log>
    80004082:	00004597          	auipc	a1,0x4
    80004086:	5b658593          	addi	a1,a1,1462 # 80008638 <syscalls+0x1e8>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800040be:	28668693          	addi	a3,a3,646 # 80021340 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    800040f2:	2407a723          	sw	zero,590(a5) # 8002133c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80004172:	1a250513          	addi	a0,a0,418 # 80021310 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800041a2:	17248493          	addi	s1,s1,370 # 80021310 <log>
  ...
  if(log.outstanding == 0){
    ...
    800041c6:	14e48493          	addi	s1,s1,334 # 80021310 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800041e2:	13248493          	addi	s1,s1,306 # 80021310 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000424c:	0f8a8a93          	addi	s5,s5,248 # 80021340 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004250:	0001da17          	auipc	s4,0x1d
    80004254:	0c0a0a13          	addi	s4,s4,192 # 80021310 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800042d6:	0607a523          	sw	zero,106(a5) # 8002133c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800042f6:	01e90913          	addi	s2,s2,30 # 80021310 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004334:	01070713          	addi	a4,a4,16 # 80021340 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004350:	fc478793          	addi	a5,a5,-60 # 80021310 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004368:	fac70713          	addi	a4,a4,-84 # 80021310 <log>
    ...
    80004378:	2dc50513          	addi	a0,a0,732 # 80008650 <syscalls+0x200>
    8000437c:	ffffc097          	auipc	ra,0xffffc
    80004380:	1c8080e7          	jalr	456(ra) # 80000544 <panic>
    panic("log_write outside of trans");
    80004384:	00004517          	auipc	a0,0x4
    80004388:	2e450513          	addi	a0,a0,740 # 80008668 <syscalls+0x218>
  ...
  log.lh.block[i] = b->blockno;
    ...
    800043a0:	f7470713          	addi	a4,a4,-140 # 80021310 <log>
  ...
  release(&log.lock);
    ...
    800043b2:	f6250513          	addi	a0,a0,-158 # 80021310 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800043de:	2ae58593          	addi	a1,a1,686 # 80008688 <syscalls+0x238>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004500:	19c58593          	addi	a1,a1,412 # 80008698 <syscalls+0x248>
    80004504:	0001d517          	auipc	a0,0x1d
    80004508:	f5450513          	addi	a0,a0,-172 # 80021458 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    80004556:	f0650513          	addi	a0,a0,-250 # 80021458 <ftable>
  ...
  return 0;
    ...
    8000456e:	eee50513          	addi	a0,a0,-274 # 80021458 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004596:	ec650513          	addi	a0,a0,-314 # 80021458 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800045f0:	e6c50513          	addi	a0,a0,-404 # 80021458 <ftable>
  ...
  release(&ftable.lock);
    ...
    8000462a:	e3250513          	addi	a0,a0,-462 # 80021458 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    800046f0:	07093503          	ld	a0,112(s2)
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    800047a6:	c1670713          	addi	a4,a4,-1002 # 800213b8 <devsw>
    ...
    800047bc:	f0050513          	addi	a0,a0,-256 # 800086b8 <syscalls+0x268>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004846:	b7670713          	addi	a4,a4,-1162 # 800213b8 <devsw>
  ...
  return ret;
    ...
    800048f0:	ddc50513          	addi	a0,a0,-548 # 800086c8 <syscalls+0x278>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004960:	d7c58593          	addi	a1,a1,-644 # 800086d8 <syscalls+0x288>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(i < n){
    ...
    80004b26:	0709b503          	ld	a0,112(s3)
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80004bee:	070a3503          	ld	a0,112(s4)
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004d54:	99050513          	addi	a0,a0,-1648 # 800086e0 <syscalls+0x290>
  ...
  uint64 oldsz = p->sz;
    80004dc6:	06853d03          	ld	s10,104(a0)
  sz = PGROUNDUP(sz);
  ...
  p->trapframe->a1 = sp;
    80004eb8:	078ab783          	ld	a5,120(s5)
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004eea:	178a8513          	addi	a0,s5,376
    80004eee:	ffffc097          	auipc	ra,0xffffc
    80004ef2:	f4a080e7          	jalr	-182(ra) # 80000e38 <safestrcpy>
  oldpagetable = p->pagetable;
    80004ef6:	070ab503          	ld	a0,112(s5)
  p->pagetable = pagetable;
    80004efa:	077ab823          	sd	s7,112(s5)
  p->sz = sz;
    80004efe:	076ab423          	sd	s6,104(s5)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    80004f02:	078ab783          	ld	a5,120(s5)
    80004f06:	e6843703          	ld	a4,-408(s0)
    80004f0a:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    80004f0c:	078ab783          	ld	a5,120(s5)
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    ...
    80005018:	b12080e7          	jalr	-1262(ra) # 80002b26 <argint>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80005032:	01e70793          	addi	a5,a4,30
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80005076:	0f050793          	addi	a5,a0,240 # fffffffffffff0f0 <end+0xffffffff7ffdcba0>
  ...
  return -1;
    ...
    80005094:	8082                	ret
      p->ofile[fd] = f;
    80005096:	01e50793          	addi	a5,a0,30
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800051b0:	55458593          	addi	a1,a1,1364 # 80008700 <syscalls+0x2b0>
    ...
    800051c8:	54458593          	addi	a1,a1,1348 # 80008708 <syscalls+0x2b8>
...
000000008000527c <sys_read>:
{
  ...
  argaddr(1, &p);
    ...
    8000528e:	8bc080e7          	jalr	-1860(ra) # 80002b46 <argaddr>
  argint(2, &n);
    80005292:	fe440593          	addi	a1,s0,-28
    80005296:	4509                	li	a0,2
    80005298:	ffffe097          	auipc	ra,0xffffe
    8000529c:	88e080e7          	jalr	-1906(ra) # 80002b26 <argint>
  if(argfd(0, 0, &f) < 0)
...
00000000800052d4 <sys_write>:
{
  ...
  argaddr(1, &p);
    ...
    800052e6:	864080e7          	jalr	-1948(ra) # 80002b46 <argaddr>
  argint(2, &n);
    800052ea:	fe440593          	addi	a1,s0,-28
    800052ee:	4509                	li	a0,2
    800052f0:	ffffe097          	auipc	ra,0xffffe
    800052f4:	836080e7          	jalr	-1994(ra) # 80002b26 <argint>
  if(argfd(0, 0, &f) < 0)
...
000000008000537a <sys_fstat>:
{
  ...
  argaddr(1, &st);
    ...
    8000538c:	7be080e7          	jalr	1982(ra) # 80002b46 <argaddr>
  if(argfd(0, 0, &f) < 0)
...
00000000800053c0 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800053da:	790080e7          	jalr	1936(ra) # 80002b66 <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800053f2:	778080e7          	jalr	1912(ra) # 80002b66 <argstr>
    return -1;
...
000000008000550a <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    80005526:	644080e7          	jalr	1604(ra) # 80002b66 <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80005556:	1ae58593          	addi	a1,a1,430 # 80008700 <syscalls+0x2b0>
    ...
    8000556e:	19e58593          	addi	a1,a1,414 # 80008708 <syscalls+0x2b8>
  ...
  return 0;
    ...
    8000562e:	0e650513          	addi	a0,a0,230 # 80008710 <syscalls+0x2c0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    8000567a:	0b250513          	addi	a0,a0,178 # 80008728 <syscalls+0x2d8>
    8000567e:	ffffb097          	auipc	ra,0xffffb
    80005682:	ec6080e7          	jalr	-314(ra) # 80000544 <panic>
    panic("unlink: writei");
    80005686:	00003517          	auipc	a0,0x3
    8000568a:	0ba50513          	addi	a0,a0,186 # 80008740 <syscalls+0x2f0>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005892:	2d8080e7          	jalr	728(ra) # 80002b66 <argstr>
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005980:	1ea080e7          	jalr	490(ra) # 80002b66 <argstr>
  ...
  iput(p->cwd);
    800059b4:	17093503          	ld	a0,368(s2)
  ...
  p->cwd = ip;
    800059c8:	16993823          	sd	s1,368(s2)
  return 0;
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005a6a:	022080e7          	jalr	34(ra) # 80002a88 <fetchaddr>
    ...
    80005a92:	04c080e7          	jalr	76(ra) # 80002ada <fetchstr>
...
sys_pipe(void)
{
  ...
  argaddr(0, &fdarray);
    ...
    80005b26:	024080e7          	jalr	36(ra) # 80002b46 <argaddr>
...
0000000080005c10 <kernelvec>:
    ...
    80005c50:	d05fc0ef          	jal	ra,80002954 <kerneltrap>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005d78:	69c78793          	addi	a5,a5,1692 # 80022410 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005d8c:	68878793          	addi	a5,a5,1672 # 80022410 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005db4:	67850513          	addi	a0,a0,1656 # 80022428 <disk+0x18>
    ...
    80005dcc:	98850513          	addi	a0,a0,-1656 # 80008750 <syscalls+0x300>
    80005dd0:	ffffa097          	auipc	ra,0xffffa
    80005dd4:	774080e7          	jalr	1908(ra) # 80000544 <panic>
    panic("free_desc 2");
    80005dd8:	00003517          	auipc	a0,0x3
    80005ddc:	98850513          	addi	a0,a0,-1656 # 80008760 <syscalls+0x310>
...
0000000080005de8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005df8:	97c58593          	addi	a1,a1,-1668 # 80008770 <syscalls+0x320>
    80005dfc:	0001c517          	auipc	a0,0x1c
    80005e00:	73c50513          	addi	a0,a0,1852 # 80022538 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005e64:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc20f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005eae:	56648493          	addi	s1,s1,1382 # 80022410 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005ed2:	54a73703          	ld	a4,1354(a4) # 80022418 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005eea:	52a48493          	addi	s1,s1,1322 # 80022410 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000600a:	53250513          	addi	a0,a0,1330 # 80022538 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000601e:	3f6b0b13          	addi	s6,s6,1014 # 80022410 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    8000602a:	512c0c13          	addi	s8,s8,1298 # 80022538 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000604c:	3c868693          	addi	a3,a3,968 # 80022410 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000609e:	38e50513          	addi	a0,a0,910 # 80022428 <disk+0x18>
  ...
  if(write)
    ...
    800060be:	35678793          	addi	a5,a5,854 # 80022410 <disk>
  ...
  buf0->reserved = 0;
    ...
    800060cc:	34858593          	addi	a1,a1,840 # 80022410 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    80006134:	2e068693          	addi	a3,a3,736 # 80022410 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800061a6:	39698993          	addi	s3,s3,918 # 80022538 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800061d0:	24478793          	addi	a5,a5,580 # 80022410 <disk>
    800061d4:	97ba                	add	a5,a5,a4
    800061d6:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800061da:	0001c997          	auipc	s3,0x1c
    800061de:	23698993          	addi	s3,s3,566 # 80022410 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80006206:	33650513          	addi	a0,a0,822 # 80022538 <disk+0x128>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80006244:	1d850513          	addi	a0,a0,472 # 80022418 <disk+0x8>
  ...
  if(write)
    ...
    8000625a:	1ba78793          	addi	a5,a5,442 # 80022410 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006274:	1a048493          	addi	s1,s1,416 # 80022410 <disk>
    80006278:	0001c517          	auipc	a0,0x1c
    8000627c:	2c050513          	addi	a0,a0,704 # 80022538 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800062f4:	24850513          	addi	a0,a0,584 # 80022538 <disk+0x128>
    ...
    8000630e:	52e50513          	addi	a0,a0,1326 # 80008838 <syscalls+0x3e8>
