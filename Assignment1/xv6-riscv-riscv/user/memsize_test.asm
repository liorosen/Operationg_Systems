...
int main() {
   ...
   e:	3d0080e7          	jalr	976(ra) # 3da <memsize>
  12:	85aa                	mv	a1,a0
  14:	00001517          	auipc	a0,0x1
  18:	85c50513          	addi	a0,a0,-1956 # 870 <malloc+0xe8>
  1c:	00000097          	auipc	ra,0x0
  20:	6ae080e7          	jalr	1710(ra) # 6ca <printf>

    void *ptr = malloc(20 * 1024); // 20KB
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	762080e7          	jalr	1890(ra) # 788 <malloc>
  2e:	84aa                	mv	s1,a0
    if (ptr == 0) {
  30:	c939                	beqz	a0,86 <main+0x86>
  ...
  36:	3a8080e7          	jalr	936(ra) # 3da <memsize>
  3a:	85aa                	mv	a1,a0
  3c:	00001517          	auipc	a0,0x1
  40:	87450513          	addi	a0,a0,-1932 # 8b0 <malloc+0x128>
  ...
  52:	6b2080e7          	jalr	1714(ra) # 700 <free>

    printf("After free: %d bytes\n", memsize());
  56:	00000097          	auipc	ra,0x0
  5a:	384080e7          	jalr	900(ra) # 3da <memsize>
  5e:	85aa                	mv	a1,a0
  60:	00001517          	auipc	a0,0x1
  64:	86850513          	addi	a0,a0,-1944 # 8c8 <malloc+0x140>
  68:	00000097          	auipc	ra,0x0
  6c:	662080e7          	jalr	1634(ra) # 6ca <printf>

    exit(0);
  70:	4501                	li	a0,0
  72:	00000097          	auipc	ra,0x0
  76:	370080e7          	jalr	880(ra) # 3e2 <exit>
    return 0;
}
  7a:	4501                	li	a0,0
  7c:	60e2                	ld	ra,24(sp)
  ...
  8a:	80a50513          	addi	a0,a0,-2038 # 890 <malloc+0x108>
  8e:	00000097          	auipc	ra,0x0
  92:	63c080e7          	jalr	1596(ra) # 6ca <printf>
        exit(1);
  96:	4505                	li	a0,1
  98:	00000097          	auipc	ra,0x0
  9c:	34a080e7          	jalr	842(ra) # 3e2 <exit>
  a0:	bf49                	j	32 <main+0x32>
...
_main()
{
  ...
  b6:	82e58593          	addi	a1,a1,-2002 # 8e0 <malloc+0x158>
  ba:	4501                	li	a0,0
  bc:	00000097          	auipc	ra,0x0
  c0:	32e080e7          	jalr	814(ra) # 3ea <exit2>
}
  c4:	60a2                	ld	ra,8(sp)
  c6:	6402                	ld	s0,0(sp)
...
gets(char *buf, int max)
{
 ...
 1be:	198080e7          	jalr	408(ra) # 352 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 210:	16e080e7          	jalr	366(ra) # 37a <open>
  if(fd < 0)
 ...
 220:	176080e7          	jalr	374(ra) # 392 <fstat>
 224:	892a                	mv	s2,a0
  close(fd);
 226:	8526                	mv	a0,s1
 228:	00000097          	auipc	ra,0x0
 22c:	13a080e7          	jalr	314(ra) # 362 <close>
  return r;
}
 230:	854a                	mv	a0,s2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 506:	3eeb8b93          	addi	s7,s7,1006 # 8f0 <digits>
 ...
 646:	2a690913          	addi	s2,s2,678 # 8e8 <malloc+0x160>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 860:	b66080e7          	jalr	-1178(ra) # 3c2 <sbrk>
  if(p == (char*)-1)
