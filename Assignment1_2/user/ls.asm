...
putc(int fd, char c)
{
 ...
 646:	f4e080e7          	jalr	-178(ra) # 590 <write>
}
...
malloc(uint nbytes)
{
 ...
 a9e:	b5e080e7          	jalr	-1186(ra) # 5f8 <sbrk>
  if(p == (char*)-1)
