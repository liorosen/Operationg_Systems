...
putc(int fd, char c)
{
 ...
 61c:	f4e080e7          	jalr	-178(ra) # 566 <write>
}
...
malloc(uint nbytes)
{
 ...
 a74:	b5e080e7          	jalr	-1186(ra) # 5ce <sbrk>
  if(p == (char*)-1)
