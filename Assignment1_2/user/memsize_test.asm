...
int main() {
  ...
  printf("Initial memory size: %d bytes\n", memsize());
   ...
   e:	3a6080e7          	jalr	934(ra) # 3b0 <memsize>
  12:	85aa                	mv	a1,a0
  14:	00001517          	auipc	a0,0x1
  18:	83c50513          	addi	a0,a0,-1988 # 850 <malloc+0xea>
  1c:	00000097          	auipc	ra,0x0
  20:	68c080e7          	jalr	1676(ra) # 6a8 <printf>

  void* ptr = malloc(20 * 1024);  // 20KB
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	740080e7          	jalr	1856(ra) # 766 <malloc>
  2e:	84aa                	mv	s1,a0
  printf("After malloc(20KB): %d bytes\n", memsize());
  30:	00000097          	auipc	ra,0x0
  34:	380080e7          	jalr	896(ra) # 3b0 <memsize>
  38:	85aa                	mv	a1,a0
  3a:	00001517          	auipc	a0,0x1
  3e:	83650513          	addi	a0,a0,-1994 # 870 <malloc+0x10a>
  42:	00000097          	auipc	ra,0x0
  46:	666080e7          	jalr	1638(ra) # 6a8 <printf>

  free(ptr);
  4a:	8526                	mv	a0,s1
  4c:	00000097          	auipc	ra,0x0
  50:	692080e7          	jalr	1682(ra) # 6de <free>
  printf("After free: %d bytes\n", memsize());
  54:	00000097          	auipc	ra,0x0
  58:	35c080e7          	jalr	860(ra) # 3b0 <memsize>
  5c:	85aa                	mv	a1,a0
  5e:	00001517          	auipc	a0,0x1
  62:	83250513          	addi	a0,a0,-1998 # 890 <malloc+0x12a>
  66:	00000097          	auipc	ra,0x0
  6a:	642080e7          	jalr	1602(ra) # 6a8 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 418:	49c50513          	addi	a0,a0,1180 # 8b0 <digits>
 41c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	3d0b8b93          	addi	s7,s7,976 # 8b0 <digits>
 ...
 624:	28890913          	addi	s2,s2,648 # 8a8 <malloc+0x142>
        while(*s != 0){
