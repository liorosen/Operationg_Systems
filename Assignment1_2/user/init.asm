...
main(void)
{
  ...
  1c:	3c4080e7          	jalr	964(ra) # 3dc <open>
  20:	06054863          	bltz	a0,90 <main+0x90>
  ...
  2a:	3ee080e7          	jalr	1006(ra) # 414 <dup>
  dup(0);  // stderr
  2e:	4501                	li	a0,0
  30:	00000097          	auipc	ra,0x0
  34:	3e4080e7          	jalr	996(ra) # 414 <dup>
  ...
  44:	8f890913          	addi	s2,s2,-1800 # 938 <malloc+0x146>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  ...
  56:	33a080e7          	jalr	826(ra) # 38c <fork>
  5a:	84aa                	mv	s1,a0
    if(pid < 0){
  5c:	04054e63          	bltz	a0,b8 <main+0xb8>
    if(pid == 0){
  60:	c92d                	beqz	a0,d2 <main+0xd2>
      wpid = wait((int *) 0, "");
  62:	85ca                	mv	a1,s2
  64:	4501                	li	a0,0
  66:	00000097          	auipc	ra,0x0
  6a:	33e080e7          	jalr	830(ra) # 3a4 <wait>
      if(wpid == pid){
  ...
  7a:	8ca50513          	addi	a0,a0,-1846 # 940 <malloc+0x14e>
  7e:	00000097          	auipc	ra,0x0
  82:	6b6080e7          	jalr	1718(ra) # 734 <printf>
        exit(1);
  86:	4505                	li	a0,1
  88:	00000097          	auipc	ra,0x0
  8c:	30c080e7          	jalr	780(ra) # 394 <exit>
    mknod("console", CONSOLE, 0);
  90:	4601                	li	a2,0
  92:	4585                	li	a1,1
  94:	00001517          	auipc	a0,0x1
  98:	84c50513          	addi	a0,a0,-1972 # 8e0 <malloc+0xee>
  9c:	00000097          	auipc	ra,0x0
  a0:	348080e7          	jalr	840(ra) # 3e4 <mknod>
    open("console", O_RDWR);
  a4:	4589                	li	a1,2
  a6:	00001517          	auipc	a0,0x1
  aa:	83a50513          	addi	a0,a0,-1990 # 8e0 <malloc+0xee>
  ae:	00000097          	auipc	ra,0x0
  b2:	32e080e7          	jalr	814(ra) # 3dc <open>
  b6:	b7bd                	j	24 <main+0x24>
      printf("init: fork failed\n");
  b8:	00001517          	auipc	a0,0x1
  bc:	84850513          	addi	a0,a0,-1976 # 900 <malloc+0x10e>
  c0:	00000097          	auipc	ra,0x0
  c4:	674080e7          	jalr	1652(ra) # 734 <printf>
      exit(1);
  c8:	4505                	li	a0,1
  ca:	00000097          	auipc	ra,0x0
  ce:	2ca080e7          	jalr	714(ra) # 394 <exit>
      exec("sh", argv);
  d2:	00001597          	auipc	a1,0x1
  d6:	f2e58593          	addi	a1,a1,-210 # 1000 <argv>
  da:	00001517          	auipc	a0,0x1
  de:	83e50513          	addi	a0,a0,-1986 # 918 <malloc+0x126>
  e2:	00000097          	auipc	ra,0x0
  e6:	2f2080e7          	jalr	754(ra) # 3d4 <exec>
      printf("init: exec sh failed\n");
  ea:	00001517          	auipc	a0,0x1
  ee:	83650513          	addi	a0,a0,-1994 # 920 <malloc+0x12e>
  f2:	00000097          	auipc	ra,0x0
  f6:	642080e7          	jalr	1602(ra) # 734 <printf>
      exit(1);
  fa:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a4:	4c850513          	addi	a0,a0,1224 # 968 <digits>
 4a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	3fcb8b93          	addi	s7,s7,1020 # 968 <digits>
 ...
 6b0:	2b490913          	addi	s2,s2,692 # 960 <malloc+0x16e>
        while(*s != 0){
