...
putc(int fd, char c)
{
 ...
 48c:	f4e080e7          	jalr	-178(ra) # 3d6 <write>
}
...
malloc(uint nbytes)
{
 ...
 8e4:	b5e080e7          	jalr	-1186(ra) # 43e <sbrk>
  if(p == (char*)-1)
