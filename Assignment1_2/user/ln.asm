...
putc(int fd, char c)
{
 ...
 3ce:	f4e080e7          	jalr	-178(ra) # 318 <write>
}
...
malloc(uint nbytes)
{
 ...
 826:	b5e080e7          	jalr	-1186(ra) # 380 <sbrk>
  if(p == (char*)-1)
